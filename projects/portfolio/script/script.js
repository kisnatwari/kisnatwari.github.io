...
/*$(document).ready(function(){
    var lines = $(".programming-quote-skill .line");
    $(".programming-quote-skill").html("");
    var arr = [];
    var i = 0;
    $(lines).each(function(){
        ...
        $(".programming-quote-skill").append(con);
        var brk = document.createElement("BR");
        $(".programming-quote-skill").append(span);
        $(".programming-quote-skill").append(brk);
    })
    var chars = document.querySelector(".programming-quote-skill").getElementsByClassName("quote-text");
    charify(chars,150);
})*/
...
write_syntax("programming-quote-home",150);
...
$(document).ready(function(){
    ...
    $(window).scroll(function(){
        ...
        if(currentPosition > skill_from_top){
            if(!skill_code_shown){
                write_syntax("programming-quote-skill",150);
                skill_code_shown = true;
            }
        }
        if(currentPosition > about_from_top){
            if(!about_statement){
                write_syntax("programming-quote-about",100);
